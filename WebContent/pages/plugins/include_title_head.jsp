...
<%
	...
	String lougout = basePath + "logout.jsp" ;
%>
					...
					<ul class="dropdown-menu"> 
						...
						<li>
							<div class="text-center">
								上次登录日期：<%=new java.text.SimpleDateFormat("yyyy-MM-dd").format(session.getAttribute("lastdate"))%>
							</div>
						</li>
						<!-- Menu Footer-->
						<li class="user-footer">
							<div class="text-center">
								<a href="<%=lougout%>" class="btn btn-default btn-flat">系统注销</a>
							</div>
						</li>
					</ul></li>
